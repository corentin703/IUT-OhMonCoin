...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'OhMonCoin') }} - Connexion</title>
                            ...
                            <div class="card" style=" width: 90%">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 offset-md-2 btn-group" role="group">
                                                <button type="submit" class="btn btn-primary">
                                                    {{ __('auth.login') }}
                                                </button>
                                                <button type="button" class="btn btn-secondary" onclick="window.location.href = '{{ route('register') }}'">{{ __('auth.register') }}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
